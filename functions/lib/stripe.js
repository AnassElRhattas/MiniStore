...
exports.confirmStripePaymentIntent = exports.createStripePaymentIntent = exports.handleStripeWebhook = exports.createStripeCheckoutSession = void 0;
 ...
 */
exports.createStripeCheckoutSession = functions.https
 ...
 */
exports.handleStripeWebhook = functions.https
...
async function handlePaymentIntentFailed(paymentIntent) {
    ...
    if (orderId) {
        await db.collection('orders').doc(orderId).update({
            ...
            paymentIntentId: paymentIntent.id,
            paymentError: ((_b = paymentIntent.last_payment_error) === null || _b === void 0 ? void 0 : _b.message) || 'Payment failed'
        });
 ...
 */
exports.createStripePaymentIntent = functions.https
    .onCall(async (data, context) => {
    try {
 ...
 */
exports.confirmStripePaymentIntent = functions.https
    .onCall(async (data, context) => {
    try {
